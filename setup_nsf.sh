...
awk '/@import "tailwindcss";/ { print @custom-variant dark (&:where(.dark, .dark *))\;; print; next } 1' app/assets/tailwind/application.css > tmpfile && mv tmpfile app/assets/tailwind/application.css
